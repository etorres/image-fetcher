...
final class AmazonS3ImagePublisher extends ImagePublisher {
  override def publish(inputFilename: String, imageDestination: ImageDestination)(
...
object AmazonS3ImagePublisher {
  def apply(): AmazonS3ImagePublisher = new AmazonS3ImagePublisher()
}
